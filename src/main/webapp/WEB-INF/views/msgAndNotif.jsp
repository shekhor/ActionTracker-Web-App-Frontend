...
<script src="${contextPath}/resources/asset/js/chatAndNotification/chat.js" type="text/javascript"></script>
<script src="${contextPath}/resources/asset/js/chatAndNotification/custom.js" type="text/javascript"></script>
